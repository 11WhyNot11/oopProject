...
function () {
  ...
  _createClass(ShowInfo, [{
    ...
    value: function createAccordion() {
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          var content = btn.closest('.module__info-show').nextElementSibling;
...
function (_Slider) {
  ...
  function MainSlider(btns, moduleNext, modulePrev) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, moduleNext, modulePrev));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.modulePrev.forEach(function (item) {
      ...
      this.moduleNext.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.preventDefault();
          e.stopPropagation();
